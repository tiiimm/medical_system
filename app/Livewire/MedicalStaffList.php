...
class MedicalStaffList extends Component
{
    ...
    {
        $this->users = User::where('role', 'medical staff')->with('profile')->get();
    }
    ...
    {
        $query = User::where('role', 'medical staff');
    ...
    {
        return redirect('/medical-staff-list/new-medical-staff');
    }
    ...
    public function showDetails($userId)
    {
        ...
        return redirect('/medical-staff-list/edit-medical-staff')->with('selectedUser', $user);
    }

    public function render()
    {
        return view('livewire.medical-staff-list');
    }
}
